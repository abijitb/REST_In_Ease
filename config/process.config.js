...
processes.push({
    ...
    error_file      : `${ PM2_LOG_PATH }/${ new Date().toDateString() }-${ new Date().toLocaleTimeString() }-API_PROCESS-err.log`,
    out_file        : `${ PM2_LOG_PATH }/${ new Date().toDateString() }-${ new Date().toLocaleTimeString() }-API_PROCESS-out.log`,
    watch           : false,
    env_development : {
        NODE_ENV       : "development"
    },
